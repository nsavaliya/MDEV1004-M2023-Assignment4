...
class AddEditAPICRUDViewController: UIViewController
{
    ...
    @IBAction func UpdateButton_Pressed(_ sender: UIButton)
    {
        ...
        if let movie = movie {
            requestType = "PUT"
            urlString = "https://mdev1004-m2023-assignment4-livesite.onrender.com/api/update/\(movie._id)"
        } else {
            requestType = "POST"
            urlString = "https://mdev1004-m2023-assignment4-livesite.onrender.com/api/add"
        }
