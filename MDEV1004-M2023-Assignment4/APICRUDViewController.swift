...
class APICRUDViewController: UIViewController, UITableViewDelegate, UITableViewDataSource
{
    ...
    func fetchMovies(completion: @escaping ([Movie]?, Error?) -> Void)
    {
        ...
        // Configure Request
        guard let url = URL(string: "https://mdev1004-m2023-assignment4-livesite.onrender.com/api/list") else
        {
            print("URL Error")
    ...
    func deleteMovie(at indexPath: IndexPath)
    {
        ...
        guard let url = URL(string: "https://mdev1004-m2023-assignment4-livesite.onrender.com/api/delete/\(movie._id)") else {
            print("Invalid URL")
            return
        }
